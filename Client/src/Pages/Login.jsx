  ...
  return (
    <div>
      <div className="items-center  max-w-[1000px]  mx-auto justify-center">
        ...
        <div>
          <div className="rounded-lg flex flex-col pt-5  border w-[450px] mx-auto mb-10 items-center gap-6 shadow-[2px_2px_10px_2px_rgba(0,0,0,0.2)]">
            <section className="w-[24rem] mb-[10px] flex flex-col gap-8">
              <div className="bg-white w-full pl-4 outline-none focus:border-black valid:border-[#017358]">
                <h1 className="text-left pb-3 text-[#001712] font-poppins  text-sm font-medium">
                  Email Address
                </h1>
                <input
                  type="email"
              ...
              <div className="bg-white w-full pl-4 outline-none">
                ...
                <p className="pt-2 text-[0.875rem] font-poppins ">
